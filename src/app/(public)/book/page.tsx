    ...
    <section className="min-h-screen pt-32 pb-20 px-6">
      <div className="max-w-3xl mx-auto text-center mb-12">
        <motion.h1
          ...
          className="font-heading text-4xl md:text-6xl font-bold text-slate-900 mb-6"
        >
        ...
        <motion.p
          ...
          className="font-mono text-slate-500 text-sm md:text-base max-w-xl mx-auto leading-relaxed"
        >
